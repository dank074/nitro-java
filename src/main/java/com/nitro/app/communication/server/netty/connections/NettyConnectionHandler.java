package com.nitro.app.communication.server.netty.connections;
...
public class NettyConnectionHandler extends SimpleChannelInboundHandler<IMessageDataWrapper> {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) {
        ...
        IConnection connection = this.nettyServer.getContainer().addConnection(this.nettyServer, new NettyConnection(ctx.channel(), ipAddress));
    ...
    public void channelUnregistered(ChannelHandlerContext ctx) {
        ...
        if(connection != null) this.nettyServer.getContainer().removeConnection(this.nettyServer, connection);
    }
